...
data_dir = pathlib.Path('.//train//audio')
...
#csak tesztelésre
train_files = filenames[:6000]
val_files = filenames[6000: 6000 + 800]
...
def get_spectrogram(waveform):
    ...
    lower_edge_hertz, upper_edge_hertz, num_mel_bins = 80, 16000 / 2, 128
